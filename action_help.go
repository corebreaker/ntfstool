...
func do_help(arg *tActionArg) error {
	...
	fmt.Println()
	fmt.Println("Some parameters are commands.")
	fmt.Println("For input and output files, there are 2 file formats (used for file recovery:")
	fmt.Println("  - The state format: to prepare recovery (intermediate states of MFT entries),")
	fmt.Println("  - The file node format: definive format by registering files, directories and their tree.")
	fmt.Println()
	fmt.Println("Global commands:")
	fmt.Println("  - help:           shows this help")
	fmt.Println()
	fmt.Println("Commands to inspect the partition:")
	fmt.Println("  - count=pattern:  shows the counts of the records that follows the record type pattern")
	fmt.Println("  - mft-names:      shows names of MFT records in MFT from the partition")
	...
	fmt.Println()
	fmt.Println("Commands to explore the input file:")
	...
	fmt.Println("  - positions=n:    shows the `n` fisrt positions of the records in the input file")
	fmt.Println("  - head=n:         shows the `n` fisrt records in the input file")
	fmt.Println("  - tail=n:         shows the `n` last records in the input file")
	...
	fmt.Println("  - show-names:     show filenames and their parent in input file")
	...
	fmt.Println()
	fmt.Println("Commands for file recovery:")
	...
	fmt.Println()
	fmt.Println("Shows the content of the MBR:", prog)
	fmt.Println()
	...
	fmt.Println(" 4.", prog, "in=01_base.dat out=02_records.dat fix-mft")
	fmt.Println(" 5.", prog, "in=02_records.dat out=03_files.dat complete")
	fmt.Println(" 6.", prog, "in=03_files.dat out=04_fslist.dat make-filelist")
	fmt.Println(" 7.", prog, "in=04_fslist.dat ls")
	fmt.Println(" 8.", prog, "in=04_fslist.dat out=recovered.file cp=12")
	fmt.Println()
